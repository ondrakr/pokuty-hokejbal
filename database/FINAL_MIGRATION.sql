-- KOMPLETNÍ MIGRACE PRO PODPORU KATEGORIÍ
...
-- ==================================================================
-- KROK 6: Přidání foreign key constraints (pokud neexistují)
-- ==================================================================
DO $$
BEGIN
...
-- ==================================================================
-- KROK 8: Vytvoření indexů pro lepší výkon
-- ==================================================================
...
-- ==================================================================
-- KROK 9: Přidání triggerů pro automatické aktualizování updated_at
-- ==================================================================
-- Trigger pro kategorie
DO $$
BEGIN
    IF NOT EXISTS (
...
-- ==================================================================
-- KROK 10: Vložení základních typů pokut pro všechny kategorie
-- ==================================================================
DO $$
DECLARE
    a_tym_id INTEGER;
